pipeline {
    environment {
        ...
        content_store_api_base_url = "https://staging.ntp.net.in/api"
        content_store_api_key="${sunbird_api_keys}"
        sunbird_cassandra_host = "11.3.2.33"
        ...
        sunbird_es_host = "11.3.2.20"
        sunbird_es_port = "9300"
        sunbird_es_index = "searchindex"
        sunbird_test_base_url = "https://staging.ntp.net.in"
        sunbird_sso_url="https://staging.ntp.net.in/auth"
        sunbird_username="ft_org_admin@org.com"
        sunbird_password="Password1"
